...
def render_workspace():
    ...
    st.caption(
        "We only return real, independent business websites — no blogs, listicles, "
        "or directory pages — so result count varies by search."
    )

    result_limit = VERCEL_SERVER_MAX_RESULTS
